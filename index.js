...
if (!channel) return;
    const colors = { entry: 0x2ecc71, optin: 0xf1c40f, expired_optin: 0xe67e22, promoted: 0x2ecc71, inactivity: 0xe74c3c, sold: 0x2ecc71, reset: 0x3498db, error: 0x95a5a6 };
     ...
     if (type === 'entry') embed.addFields({ name: "User", value: `<@${data.userId}>`, inline: true }, { name: "Position", value: `#${data.position}`, inline: true }, { name: "Est. Wait", value: `~${data.waitTime} minutes`, inline: true });
     ...
     else if (type === 'promoted') embed.addFields({ name: "New #1", value: `<@${data.userId}>`, inline: true }, { name: "Previous #1", value: data.previousUser ? `<@${data.previousUser}>` : 'None', inline: true }, { name: "Time Left", value: `${data.timeLeft} minutes`, inline: true });
