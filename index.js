...
`SELECT GREATEST( 0, EXTRACT(EPOCH FROM (expires_at - NOW())) )::INT AS seconds_left FROM product_reservations WHERE user_id = $1 AND product_id = $2 AND status = 'ACTIVE' LIMIT 1`,
[userId, productId]
);
